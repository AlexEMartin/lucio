const recuerdosmargaritasText = [
  ...
  "Ante estas preguntas experimentaremos lo que nos sucede al tratar de responderlas con la intención de llevar al público a otro tiempo. Es el intento imposible de traducir por medio del flamenco, la danza contemporánea, el teatro, el humor, la acrobacia y la música en vivo, conceptos abstractos a través de una clásica historia de amor.",
];
